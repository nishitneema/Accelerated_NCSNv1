...
def get_fid_stats_path(args, config, download=True):
    if config.data.dataset == 'CIFAR10':
        ...
        # path = os.path.join("/data4/home/manikantab/Diffusion_models/score_based_networks/ncsnv2/exp/datasets/cifar10_fid.npz")
        ...
        if not os.path.exists(path):
            path = "/data4/home/manikantab/Diffusion_models/IADB/celebA_50k"
            # raise FileNotFoundError('no statistics file founded')
